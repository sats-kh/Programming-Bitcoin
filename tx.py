...
class Tx:
    ...
    def id(self):
        '''Human-readable hexadecimal of the transcation hash'''
    ...
    # Quiz 5.1, Quiz 5.2, Quiz 5.3, Quiz 5.4
    @classmethod
    ...
    def fetch(cls, tx_id, testnet=False, fresh=False):
        if fresh or (tx_id not in cls.cache):
            ...
            try :
                ...
                raise ValueError('unexpected response: {}'.formant(response.text))
            if raw[4] == 0:
                raw = raw[:4] + raw[6:]
